...
namespace UI.UIObject3D.Scripts.Editor
{
    public class UIObject3DProcessor : AssetModificationProcessor
    {
        ...
        private static void HandlePlayModeSwitches()
        {
        ...
        {
            var objects = Object.FindObjectsByType<UIObject3D>(FindObjectsSortMode.None).ToList();

            foreach (var o in objects) o.Cleanup();
        }
