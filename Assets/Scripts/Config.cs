...
public static class Config
{
    public static readonly List<PieceConfig> PieceConfigWhite = new()
    {
         ...
         new PieceConfig(PieceType.Chrysos, false, 55),
        new PieceConfig(PieceType.Seahorse, false, 56),
        new PieceConfig(PieceType.Seahorse, false, 57),
        new PieceConfig(PieceType.Remora, false, 99),
        // new PieceConfig(PieceType.MedicalLeech, false, 102),
