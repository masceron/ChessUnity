...
namespace Game.Augmentation
{
    ...
    {
        public CrownOfSilence() : base(AugmentationName.CrownOfSilence, AugmentationRarity.Rare, AugmentationSlot.Fin, null, null)
        {
        ...
        public override void SetTarget(PieceLogic target)
        {
            ...
            {
                PassiveEffects.Add(new CrownOfSilencePassive(enemyCommander));
            }
        }
    }
}