...
namespace Game.Augmentation
{
    ...
    {
        public Echolocator() : base(AugmentationName.EchoLocator, AugmentationRarity.Rare, AugmentationSlot.Fin, null,
            null)
        {
        ...
        public override void SetTarget(PieceLogic target)
        {
            ...
            PassiveEffects.Add(new EcholocatorPassive(Target));
        }
    }
}