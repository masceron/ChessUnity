...
namespace Game.Effects.Others
{
    ...
    {
        public UmbrellaSlugSpecialAbility(PieceLogic piece) : base(-1, 100, piece,
            "effect_umbrella_slug_special_ability")
        {
        }
        ...
        {
            if (action is not NormalMove move || action.GetMaker() as PieceLogic != Piece ||
