...
namespace Game.Action.Internal.Pending.Relic
{
    ...
    public class SirensHarpoonPending : Action, IPendingAble, System.IDisposable, IRelicAction
    {
        ...
        {
            ActionManager.ExecuteImmediately(new ApplyEffect(new Controlled(-1, BoardUtils.PieceOn(Target)), _sirensHarpoon));
            ActionManager.ExecuteImmediately(new ApplyEffect(new Pacified(1, BoardUtils.PieceOn(Target)), _sirensHarpoon));
